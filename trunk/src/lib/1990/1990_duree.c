...
int _1990_duree_projet_eu(unsigned int type)
/* Description : Renvoie la durée (en année) indicative de la norme européenne. Dans le cas où
 *               la durée indiquée par la norme européenne est un intervalle d'années, la durée
 *               la plus importante est renvoyée.
...
int _1990_duree_projet_fr(unsigned int type)
...
char* _1990_duree_projet_txt_eu(unsigned int type)
...
char* _1990_duree_projet_txt_fr(unsigned int type)
/* Description : renvoie la description des catérogies des durées indicative de la norme
 *               française.
 *               FONCTION INTERNE. Utiliser _1990_duree_projet_txt.
 * Paramètres : unsigned int type : catégorie de durée d'utilisation de projet.
