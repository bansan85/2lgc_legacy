...
/* Description : Convertion des triplets contenant la matrice de rigidité partielle et
 *               complète sous forme d'une matrice sparse et factorisation de la matrice
 *               partielle.
 * Paramètres : Projet *projet : la variable projet
 * Valeur renvoyée :
 *   Succès : 0
