...
class IUndoableFonction
{
  ...
  public :
     ...
     * \return bool CHK
     */
    virtual bool CHK doXML (xmlNodePtr node);
    /**
     * \brief La description de la modification.
     * \return const std::string &
     */
    virtual const std::string & doDescription ();
    /**
     * \brief Annule la fonction.
     * \return bool CHK
     */
    virtual bool CHK undo ();
    /**
     * \brief Format XML  pour annuler les modifications.
     * \param node (in) Le noeud où ajouter les informations.
     * \return bool CHK
     */
    virtual bool CHK undoXML (xmlNodePtr node);
    /**
     * \brief La description de l'annulation.
     * \return const std::string &
     */
    virtual const std::string & undoDescription ();
    /**
