...
int main(int argc, char *argv[])
{
    ...
    BUG(_1992_1_1_barres_ajout(projet, BETON_ELEMENT_POUTRE, _1992_1_1_sections_cherche_nom(projet, "Rect_0.3*0.5"), _1992_1_1_materiaux_cherche_nom(projet, "B25"), 0, 1, NULL, 0), -1);
    BUG(_1992_1_1_barres_ajout(projet, BETON_ELEMENT_POUTRE, _1992_1_1_sections_cherche_nom(projet, "Rect_0.3*0.5"), _1992_1_1_materiaux_cherche_nom(projet, "B25"), 1, 2, NULL, 0), -1);
    BUG(_1992_1_1_barres_ajout(projet, BETON_ELEMENT_POUTRE, _1992_1_1_sections_cherche_nom(projet, "Rect_0.3*0.5"), _1992_1_1_materiaux_cherche_nom(projet, "B25"), 2, 3, NULL, 0), -1);
