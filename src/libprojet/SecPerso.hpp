#ifndef SECPERSO__HPP
#define SECPERSO__HPP
 ...
 */
class SecPerso : public ISection
{
  // Attributes
  private :
  ...
  public :
    /**
     * \brief Constructeur d'une classe SecPerso.
     ...
     */
    SecPerso (std::string description, INb * j, INb * iy, INb * iz, INb * vy, INb * vyp, INb * vz, INb * vzp, INb * s, std::list <std::list <CPoint *> *> * forme, UndoManager & undo);
    /**
     * \brief Duplication d'une classe SecPerso.
     * \param other (in) La classe à dupliquer.
     */
    SecPerso (const SecPerso & other);
    /**
     * \brief Assignment operator de SecPerso.
     * \param other (in) La classe à dupliquer.
     * \return SecPerso &
     */
    SecPerso & operator = (const SecPerso & other);
    /**
     * \brief Destructeur d'une classe SecPerso.
     */
    virtual ~SecPerso ();
    /**
