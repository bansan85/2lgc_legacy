...
class NdLibre : public INoeud
{
  ...
  public :
    /**
     * \brief Constructeur d'une classe NdLibre.
     ...
     */
    NdLibre (INb * x, INb * y, INb * z, INoeud * nd, UndoManager & undo);
    /**
     * \brief Duplication d'une classe NdLibre.
     * \param other (in) La classe à dupliquer.
     */
    NdLibre (const NdLibre & other) = delete;
    /**
     * \brief Assignment operator de NdLibre.
     * \param other (in) La classe à dupliquer.
     * \return NdLibre &
     */
    NdLibre & operator = (const NdLibre & other) = delete;
    /**
     * \brief Destructeur d'une classe CNdLibre.
     */
    virtual ~NdLibre ();
    /**
