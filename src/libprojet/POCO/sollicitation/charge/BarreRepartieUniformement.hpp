#ifndef POCO_SOLLICITATION_CHARGE_BARREREPARTIEUNIFORMEMENT__HPP
#define POCO_SOLLICITATION_CHARGE_BARREREPARTIEUNIFORMEMENT__HPP
...
namespace POCO
{
  namespace sollicitation
  {
    namespace charge
    {
       ...
       */
      class BarreRepartieUniformement : public POCO::sollicitation::ICharge
      {
        // Attributes
        private :
        ...
        public :
          /**
           * \brief Constructeur d'une classe BarreRepartieUniformement.
           ...
           */
          BarreRepartieUniformement (const BarreRepartieUniformement & other) = delete;
          /**
           * \brief Assignment operator de BarreRepartieUniformement.
           * \param other (in) La classe à dupliquer.
           * \return BarreRepartieUniformement &
           */
          BarreRepartieUniformement & operator = (const BarreRepartieUniformement & other) = delete;
          /**
           * \brief Destructeur d'une classe BarreRepartieUniformement.
           */
          virtual ~BarreRepartieUniformement ();
          /**
