#ifndef POCO_SOLLICITATION_CHARGE_BARREPONCTUELLE__HPP
#define POCO_SOLLICITATION_CHARGE_BARREPONCTUELLE__HPP
...
namespace POCO
{
  namespace sollicitation
  {
    namespace charge
    {
       ...
       */
      class BarrePonctuelle : public POCO::sollicitation::ICharge
      {
        // Attributes
        private :
        ...
        public :
          /**
           * \brief Constructeur d'une classe BarrePonctuelle.
           ...
           */
          BarrePonctuelle (std::string nom, std::list <CBarre *> barres, bool repere, INb * position, INb * fx, INb * fy, INb * fz, INb * mx, INb * my, INb * mz, UndoManager & undo);
          /**
           * \brief Duplication d'une classe BarrePonctuelle.
           * \param other (in) La classe à dupliquer.
           */
          BarrePonctuelle (const BarrePonctuelle & other) = delete;
          /**
           * \brief Assignment operator de BarrePonctuelle.
           * \param other (in) La classe à dupliquer.
           * \return BarrePonctuelle &
           */
          BarrePonctuelle & operator = (const BarrePonctuelle & other) = delete;
          /**
           * \brief Destructeur d'une classe BarrePonctuelle.
           */
          virtual ~BarrePonctuelle ();
          /**
