#ifndef POCO_SOLLICITATION_CNIVEAUGROUPE__HPP
#define POCO_SOLLICITATION_CNIVEAUGROUPE__HPP
...
namespace POCO
{
  namespace sollicitation
  {
    ...
    class CNiveauGroupe
    {
      ...
      private :
        /// La liste.
        std::list <POCO::sollicitation::action::IActionGroupe *> groupes;
      // Operations
      public :
        /**
         ...
         */
        CNiveauGroupe (std::list <POCO::sollicitation::action::IActionGroupe *> * liste);
        /**
         ...
         * \return bool CHK
         */
        bool CHK addGroupes (std::list <POCO::sollicitation::action::IActionGroupe *> * liste );
        /**
         * \brief Enlève plusieurs groupes au niveau.
         * \param liste (in) La liste des groupes à enlever.
         * \return bool CHK
         */
        bool CHK rmGroupes (std::list <POCO::sollicitation::action::IActionGroupe *> * liste);
    };
  }
}
