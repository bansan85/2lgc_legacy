#ifndef POCO_SOL_ACTION_CGROUPE__HPP
#define POCO_SOL_ACTION_CGROUPE__HPP
...
#include "POCO/sol/action/ECombinaison.hpp"
#include "POCO/sol/action/IActionGroupe.hpp"
#include "POCO/sol/CCombinaison.hpp"
...
namespace POCO
{
  namespace sol
  {
    namespace action
    {
       ...
       */
      class CGroupe : public POCO::sol::action::IActionGroupe
      {
        // Associations
        // Attributes
        private :
          /// Le type de combinaisons des éléments.
          POCO::sol::action::ECombinaison combinaison;
