#ifndef POCO_SOL_CACTION__HPP
#define POCO_SOL_CACTION__HPP
...
#include "POCO/calc/CFonction.hpp"
...
namespace POCO
{
  namespace sol
  {
     ...
     */
    class DllExport CAction : public POCO::sol::action::IActionGroupe
    {
      // Associations
      // Attributes
      private :
        ...
        std::list <std::shared_ptr <POCO::sol::ICharge> > charges;
        ...
        std::array <std::vector <POCO::calc::CFonction *>, 6> efforts;
        /// Les 3 déformations x, y, z pour chaque barre dans le repère local.
        std::array <std::vector <POCO::calc::CFonction *>, 3> deformation;
        /// Les 3 rotations rx, ry, rz pour chaque barre dans le repère local.
        std::array <std::vector <POCO::calc::CFonction *>, 3> rotation;
      // Operations
      public :
        /**
         ...
         * \return bool CHK
         */
        bool CHK addCharges (std::list <std::shared_ptr <POCO::sol::ICharge> > & charges_);
        /**
         * \brief Enlève plusieurs charges à l'action.
         * \param charges_ (in) La liste de charges à enlever.
         * \return bool CHK
         */
        bool CHK rmCharges (std::list <POCO::sol::ICharge *> * charges_);
    };
  }
}
