#ifndef POCO_SOL_CHARGE_BARREREPARTIEUNIFORMEMENT__HPP
#define POCO_SOL_CHARGE_BARREREPARTIEUNIFORMEMENT__HPP
...
namespace POCO
{
  namespace sol
  {
    namespace charge
    {
       ...
       */
      class BarreRepartieUniformement : public POCO::sol::ICharge
      {
        // Attributes
        private :
