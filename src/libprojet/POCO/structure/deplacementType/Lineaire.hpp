#ifndef POCO_STRUCTURE_DEPLACEMENTTYPE_LINEAIRE__HPP
#define POCO_STRUCTURE_DEPLACEMENTTYPE_LINEAIRE__HPP
...
namespace POCO
{
  namespace structure
  {
    namespace deplacementType
    {
       ...
       */
      class Lineaire : public POCO::structure::IDeplacementType
      {
        // Attributes
        private :
