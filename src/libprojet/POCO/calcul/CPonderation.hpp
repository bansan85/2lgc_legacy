#ifndef POCO_CALCUL_CPONDERATION__HPP
#define POCO_CALCUL_CPONDERATION__HPP
  ...
  namespace calcul
  {
    ...
    class CPonderation
    {
      ...
      public :
         ...
         */
        CPonderation (CAction * action, double ponderation, int8_t psi);
        /**
         ...
         * \return bool CHK
         */
        bool CHK setAction (CAction * action_);
        /**
