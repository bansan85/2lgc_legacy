#ifndef CNIVEAUGROUPE__HPP
#define CNIVEAUGROUPE__HPP
...
class CNiveauGroupe
{
  ...
  private :
    /// La liste.
    std::list <IActionGroupe *> groupes;
  // Operations
  public :
    /**
     ...
     * \return bool CHK
     */
    bool CHK addGroupes (std::list <IActionGroupe *> * liste );
    /**
     * \brief Enlève plusieurs groupes au niveau.
     * \param liste (in) La liste des groupes à enlever.
     * \return bool CHK
     */
    bool CHK rmGroupes (std::list <IActionGroupe *> * liste);
};
