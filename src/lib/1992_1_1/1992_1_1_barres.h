...
gboolean _1992_1_1_barres_cherche_dependances(Projet *projet, GList* noeuds, GList* barres, GList** noeuds_dep, GList** barres_dep, GList **charges_dep, gboolean numero, gboolean origine) __attribute__((__warn_unused_result__));
