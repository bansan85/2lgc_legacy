 ...
 *                             GList *points pouvant former des formes indépendantes.
 *                             La forme dessinée depuis la liste des points est automatiquement
 *                             fermée (le premier point rejoint le dernier).
 * Valeur renvoyée :
 *   Succès : TRUE
 *   Échec : FALSE :
 *             forme == NULL,
