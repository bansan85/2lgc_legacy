      ...
      char   *argv[])
{
  ...
  BUGCONT (projet.enregistre ("undomanager2.xml"), -1, static_cast <UndoManager *> (nullptr))
  
  xmlNodePtr root_node, n0, n1, n2, n3;
  
  BUGCONT (root_node = xmlNewNode (nullptr, BAD_CAST2 ("Projet")), -1, static_cast <UndoManager *> (nullptr))
  
  BUGCONT (projet.undoToXML (root_node), false, static_cast <UndoManager *> (nullptr))
  
  n0 = root_node;
  BUGCONT (n0->type == XML_ELEMENT_NODE, -1, static_cast <UndoManager *> (nullptr))
  BUGCONT (std::string ("Projet").compare (BAD_TSAC2 (n0->name)) == 0,
           -1,
           static_cast <UndoManager *> (nullptr))
  BUGCONT (n1 = n0->children, -1, static_cast <UndoManager *> (nullptr))
  BUGCONT (n1->type == XML_ELEMENT_NODE, -1, static_cast <UndoManager *> (nullptr))
  BUGCONT (std::string ("UndoManager").compare (BAD_TSAC2 (n1->name)) == 0,
           -1,
           static_cast <UndoManager *> (nullptr))
  BUGCONT (n2 = n1->children, -1, static_cast <UndoManager *> (nullptr))
  BUGCONT (n2->type == XML_ELEMENT_NODE, -1, static_cast <UndoManager *> (nullptr))
  BUGCONT (std::string ("Bloc").compare (BAD_TSAC2 (n2->name)) == 0, -1, static_cast <UndoManager *> (nullptr))
  BUGCONT (n3 = n2->children, -1, static_cast <UndoManager *> (nullptr))
  BUGCONT (n3->type == XML_ELEMENT_NODE, -1, static_cast <UndoManager *> (nullptr))
  ...
  BUGCONT (n2 = n2->next, -1, static_cast <UndoManager *> (nullptr))
  BUGCONT (n2->type == XML_ELEMENT_NODE, -1, static_cast <UndoManager *> (nullptr))
  BUGCONT (std::string ("Bloc").compare (BAD_TSAC2 (n2->name)) == 0, -1, static_cast <UndoManager *> (nullptr))
  BUGCONT (prop = xmlGetProp (n2, BAD_CAST2 ("Heure")), -1,static_cast <UndoManager *> (nullptr))
  BUGCONT (n3 = n2->children, -1, static_cast <UndoManager *> (nullptr))
  BUGCONT (n3->type == XML_ELEMENT_NODE, -1, static_cast <UndoManager *> (nullptr))
  ...
  // modifications.
  prop = xmlGetProp (n3, BAD_CAST2 ("Nom"));
  BUGCONT (std::string ("Neige").compare (BAD_TSAC2 (prop)) == 0, -1, static_cast <UndoManager *> (nullptr))
  xmlFree (prop);
