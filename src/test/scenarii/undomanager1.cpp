      ...
      char   *argv[])
{
  ...
  BUGCONT (projet.addAction (action.get ()), -1, static_cast <CUndoManager *> (nullptr))
  action.release ();
  BUGCONT (projet.getActionCount () == 3, -1, static_cast <CUndoManager *> (nullptr))
  // 19 Vent
  action.reset (new CAction (new std::string ("Vent"), 19, projet));
  BUGCONT (projet.addAction (action.get ()), -1, static_cast <CUndoManager *> (nullptr))
  action.release ();
  BUGCONT (projet.getActionCount () == 4, -1, static_cast <CUndoManager *> (nullptr))
  ...
  BUGCONT (projet.enregistre ("undomanager1.xml"), -1, static_cast <CUndoManager *> (nullptr))
